  ...
  return (
    <div className="w-full h-full max-w-7xl mx-auto flex flex-col gap-1 select-none md:select-text">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 min-h-[500px]">
        ...
        <div className="bg-white rounded-[2rem] p-5 shadow-sm border border-neutral-200/60 flex flex-col gap-4 h-[650px] max-lg:h-auto max-lg:min-h-[350px]">
          
          {/* Name Input Box (텍스트 대치) */}
          <div className="bg-blue-50/50 border border-blue-100/50 p-3 rounded-2xl flex items-center gap-2.5">
            <User className="w-5 h-5 text-blue-600 shrink-0 ml-1" />
            <form onSubmit={handleApplyReplacement} className="flex-1 flex gap-3">
              ...
              <Button
                type="submit"
                size="sm"
                className="bg-blue-600 hover:bg-blue-700 text-white font-medium px-4 h-[38px] rounded-xl shadow-sm text-[13px] cursor-pointer shrink-0 border-none"
              >
                대치
              </Button>
            </form>

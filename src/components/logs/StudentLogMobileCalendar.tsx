                        ...
                        {isEditing && editForm ? (
                          <div className="w-[120px]">
                            <StudentCombobox
                              ...
                              placeholder="학생선택"
                              inputClassName="bg-white border-solid border-zinc-200 text-xs h-7 py-0 px-2"
                              className="!w-[120px]"
                            />
                          </div>
                        ) : (
                      ...
                      <div className="flex items-center gap-1 shrink-0">
                        {isEditing ? (
                          <>
                            <Button 
                              size="sm" 
                              className="h-6 px-2.5 text-[11.5px] bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-lg shadow-sm cursor-pointer"
                            ...
                            <Button 
                              size="sm" 
                              variant="ghost" 
                              className="h-6 px-2 text-[11.5px] text-zinc-500 hover:bg-zinc-100 rounded-lg cursor-pointer"
                              onClick={() => {
                                setEditingLog(null);
                                setEditForm(null);
                              }}
        ...
        <DialogContent className="sm:max-w-[360px] rounded-[2.5rem] border-none shadow-2xl p-0 overflow-hidden bg-white animate-in fade-in zoom-in-95 duration-250">
          <div className="p-8 text-center space-y-6">
            ...
            <div className="space-y-1.5">
              <h3 className="text-[17px] font-semibold text-foreground">교무수첩 기록 삭제</h3>
              <p className="text-xs text-zinc-500 font-medium leading-relaxed">
                <span className="text-destructive font-bold">'{deletingItem?.name}'</span> 학생의 <br />
                <span className="font-bold text-zinc-700">'{deletingItem?.category}'</span> 기록을 삭제하시겠습니까?
              </p>
            </div>
            ...
            <div className="flex gap-3">
              <Button 
                type="button"
                variant="secondary" 
                className="flex-1 h-11 rounded-xl font-bold cursor-pointer text-xs"
              ...
              <Button 
                type="button"
                variant="destructive"
                className="flex-1 h-11 rounded-xl font-bold shadow-lg shadow-destructive/20 cursor-pointer text-xs"

...
export const TAG_COLORS: Record<string, string> = {
  ...
  green: 'bg-green-700/15 text-emerald-950 font-medium',
  blue: 'bg-sky-700/15 text-blue-950 font-medium',
  ...
  초록색: 'bg-green-700/15 text-emerald-950 font-medium',
  파란색: 'bg-sky-700/15 text-blue-950 font-medium',

...
export const TAG_COLORS: Record<string, string> = {
  ...
  brown: 'bg-amber-800/17 text-yellow-950 font-medium',
  ...
  blue: 'bg-sky-600/15 text-blue-950 font-medium',
  ...
  갈색: 'bg-amber-800/17 text-yellow-950 font-medium',
  ...
  파란색: 'bg-sky-600/15 text-blue-950 font-medium',
